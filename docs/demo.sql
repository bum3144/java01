...
CREATE TABLE CUSTOMERS (
	CNO      INTEGER      NOT NULL COMMENT '고객번호', -- 고객번호
	NAME     VARCHAR(50)  NOT NULL COMMENT '고객이름', -- 고객이름
	TEL      VARCHAR(30)  NULL     COMMENT '전화', -- 전화
	DET_ADDR VARCHAR(255) NULL     COMMENT '이메일', -- 이메일
	EMAIL    VARCHAR(40)  NOT NULL COMMENT '상세주소', -- 상세주소
...
-- 제조사정보
CREATE TABLE MAKERS (
	COMP_CORD VARCHAR(20)  NOT NULL COMMENT '사업자번호', -- 사업자번호
...
CREATE TABLE PRODUCTS (
	PNO       INTEGER      NOT NULL COMMENT '제품번호', -- 제품번호
	TITLE     VARCHAR(255) NOT NULL COMMENT '새 컬럼', -- 새 컬럼
	QTY       INTEGER      NOT NULL COMMENT '제품명', -- 제품명
	COMP_CORD VARCHAR(20)  NOT NULL COMMENT '사업자번호' -- 사업자번호
)
COMMENT '제품정보';
...
-- 주문정보
ALTER TABLE ORDERS
	ADD CONSTRAINT FK_CUSTOMERS_TO_ORDERS -- 고객정보 -> 주문정보
		FOREIGN KEY (
			CNO -- 고객번호
		)
